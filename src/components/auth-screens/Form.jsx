...
const Form = ({
    ...
    return (
        <form
            className={`z-1 flex w-full ${maxWidthClasses[maxWidth]} flex-col items-center gap-y-6 rounded-2xl border border-gray-300 bg-black/90 px-4 py-12 text-white shadow-sm md:px-16 ${className}`}
            {...props}
        >
