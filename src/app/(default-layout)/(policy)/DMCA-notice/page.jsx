        ...
        <div className="w-full space-y-4 py-4">
            ...
            <div className="border-b border-gray-50 pb-6">
                <div className="font-medium text-lg flex items-center gap-x-2">
                    ...
                    <h3 className="text-lg font-medium">Take Down Procedure</h3>
                </div>
                <p className="text-lg">If you believe that your work has been copied in a way that constitutes copyright infringement, please provide Our Designated Copyright Agent (identified below) with the following information: (a) an electronic or physical signature of the person authorized to act on behalf of the owner of the copyright or other intellectual property interest; (b) description of the copyrighted work or other intellectual property that you claim has been infringed; (c) a description of where the material that you claim is infringing is located on the SITE (preferably including specific url's associated with the material); (d) your address, telephone number, and email address; (e) a statement by you that you have a good faith belief that the disputed use is not authorized by the copyright owner, its agent, or the law; and, (f) a statement by you, made under penalty of perjury, that the above information in your Notice is accurate and that you are the copyright or intellectual property owner or authorized to act on the copyright or intellectual property owner's behalf. You may send your Notice of Claimed Infringement, by mail transmission only, to: email • dmca@rentboy.com</p>
            </div>
            ...
            <div className="font-medium text-lg flex items-center gap-x-2">
                ...
                <h3 className="text-lg font-medium">DMCA Agent:</h3>
            </div>
            ...
            <ul>
                ...
                <li>Kanzlei Kötz Fusbahn Rechtsanwälte Partnership ltd. Rosenst. 11a</li>
                <li>1234 Elm Street Springfield, IL 62701 USA </li>
                <li>Website: <span className="text-red-50"><a href=" rentboys.com" target="_blank"></a></span></li>
            </ul>

            <div className="flex justify-end">
                <Button label="Submit a DMCA complaint" size="md" />
            </div>
