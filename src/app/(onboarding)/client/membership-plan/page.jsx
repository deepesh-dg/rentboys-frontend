...
export default function Page() {
    ...
    return (
        <>
            <div className="relative flex min-h-screen w-full flex-col items-center justify-center backdrop-blur-sm">
                <div
                ...
                <Form
                    maxWidth="5xl"
                    className="!gap-y-0 overflow-x-auto !px-6 !py-6"
                >
                    ...
                    <div className="my-2 grid w-full grid-cols-5 gap-2 rounded-xl">
                        <div className="col-span-2 flex w-full items-center justify-between rounded-md bg-gray-100 p-4">
                            <p className="font-medium">
                                Search and Contact Performers
                            </p>
                            <Icons icon={ArrowDownIcon} className="w-5" />
                        </div>
                        <div className="col-span-3 flex w-full rounded-md bg-gray-100 p-4">
